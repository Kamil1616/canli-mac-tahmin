...
def get_team_form(team_id=None, fixture_id=None, team_name=None):
    ...
    CUP_KW = ["cup", "kupa", "copa", "coupe", "pokal", "supercup",
              "friendly", "super cup", "champions", "europa", "conference"]
    DECAY = 0.75
    LIG_ORT = 1.25
    ...
    for idx, m in enumerate(team_matches):
        ...
        try:
            match_date = (datetime.utcfromtimestamp(m.get("matchTime", 0))
